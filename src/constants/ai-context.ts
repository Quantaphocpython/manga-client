...
export const LAYOUT_PROMPTS: Record<string, string> = {
  'Single Panel':
    'ONE SINGLE FULL-PAGE illustration with NO panel divisions or borders. The entire image is one continuous artwork.',
  'Double Panel':
    'EXACTLY TWO PANELS with clear black borders separating them. Arrange panels side-by-side or stacked vertically.',
  'Triple Panel':
    'EXACTLY THREE PANELS with clear black borders between each panel. Can be arranged vertically, horizontally, or in L-shape.',
  'Grid Layout':
    'EXACTLY FOUR PANELS arranged in a 2x2 grid with clear black borders creating a grid pattern.',
  'Dramatic Spread':
    'ONE WIDE cinematic illustration spanning two pages side-by-side for maximum dramatic impact.',
